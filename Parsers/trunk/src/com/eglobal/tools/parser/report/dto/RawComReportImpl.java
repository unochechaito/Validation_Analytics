...
public class RawComReportImpl implements Report {
    ...
    public static class RawComReportImplBuilder {
        @java.lang.SuppressWarnings("all")
        private String proceso;
        @java.lang.SuppressWarnings("all")
        private String dispatcher;
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder proceso(final String proceso) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder dispatcher(final String dispatcher) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder pem(final String pem) {
            this.pem = pem;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder processingCode(final String processingCode) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder bin(final String bin) {
            this.bin = bin;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public RawComReportImpl.RawComReportImplBuilder fields(final List<String> fields) {
            this.fields = fields;
            return this;
        }

        @java.lang.SuppressWarnings("all")
        public RawComReportImpl build() {
            return new RawComReportImpl(this.proceso, this.dispatcher, this.pem, this.processingCode, this.bin, this.fields);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
            return "RawComReportImpl.RawComReportImplBuilder(proceso=" + this.proceso + ", dispatcher=" + this.dispatcher + ", pem=" + this.pem + ", processingCode=" + this.processingCode + ", bin=" + this.bin + ", fields=" + this.fields + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
    public static RawComReportImpl.RawComReportImplBuilder builder() {
        return new RawComReportImpl.RawComReportImplBuilder();
    }

    @java.lang.SuppressWarnings("all")
    public RawComReportImpl(final String proceso, final String dispatcher, final String pem, final String processingCode, final String bin, final List<String> fields) {
        this.proceso = proceso;
        this.dispatcher = dispatcher;
        this.pem = pem;
        this.processingCode = processingCode;
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof RawComReportImpl)) return false;
        final RawComReportImpl other = (RawComReportImpl) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof RawComReportImpl;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public java.lang.String toString() {
        return "RawComReportImpl(proceso=" + this.getProceso() + ", dispatcher=" + this.getDispatcher() + ", pem=" + this.getPem() + ", processingCode=" + this.getProcessingCode() + ", bin=" + this.getBin() + ", fields=" + this.getFields() + ")";
    }
}
