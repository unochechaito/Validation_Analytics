...
public class EAcquirerView {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof EAcquirerView)) return false;
		final EAcquirerView other = (EAcquirerView) o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof EAcquirerView;
	}
	...
	public java.lang.String toString() {
		return "EAcquirerView(id=" + this.getId() + ", timestamp=" + this.getTimestamp() + ", dispatcher=" + this.getDispatcher() + ", bin=" + this.getBin() + ", category=" + this.getCategory() + ", fingerprint=" + this.getFingerprint() + ", key=" + this.getKey() + ", requirementMessage=" + this.getRequirementMessage() + ", responseMessage=" + this.getResponseMessage() + ")";
	}
}
