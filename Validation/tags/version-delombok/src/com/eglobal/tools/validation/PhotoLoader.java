...
public class PhotoLoader extends JPanel {
            ...
            if (suppressSelectionEvent) {
                ...
                if (selectedPhotoName != null && !"Seleccionar foto".equals(selectedPhotoName)) {
                    if (csvComparator == null) {
                        JOptionPane.showMessageDialog(null, "El comparador CSV no está inicializado.", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if (leftDirectory == null || leftDirectory.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "El directorio Base no está configurado.", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if (rightDirectory == null || rightDirectory.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "El directorio A comparar no está configurado.", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    try {
    ...
    public void executeCsvComparison(String selectedPhoto) {
        if (leftDirectory == null || rightDirectory == null) {
            JOptionPane.showMessageDialog(this, "Los directorios Base y A comparar no están configurados.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
